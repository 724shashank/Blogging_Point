...
<center><img src="images/reg.png" style="width:100px;height:100px;margin:10px;"></center>
	...
	<center><table  width="1050px" height="500px">
			...
			<tr>
				<th colspan="2"><input type="text" placeholder="Adderess"style="width:1040px;height: 100px;font-size: 20pt;font-family: Comic Sans MS;" required name="addr"></th>
			</tr>
			...
			<tr>
				...
				<th><div class="div">
				<span style="opacity:0.5;font-size:20px;float:left">Profile-Photo</span>
...
$q1="insert into registration(username,name,pswd,state,city,address,dob,mob,utype,uphoto,status)values('$user','$name','$pswd','$state','$city','$address','$dob','$mobile','$utype','$folder','allowed')";
