<?php include("anav.php");?>
     ...
     echo "<h2 style='display:inline;'>".$title."</h2><a href='userhome.php' style='margin-left:1210px;'><button>Back</button></a>";
     echo "<h5>".$date."</h5>";
     echo "<img src='".$image."' style='width:1410px;height:150px;'>";
     echo"<div><p style='text-align:justify;'>".$stext."</p></div>";
     echo"<b>By:</b>".$dname."<br>";
     echo"<br><a href='acontant.php?id=".$id."'><button name='id'>Read_More</button></a>";
     echo"<hr></div></div>";
      ...
      echo "<h2 style='display:inline;'>".$row[3]."</h2><a href='userhome.php' style='margin-left:1210px;'><button>Back</button></a>";
      echo "<h5>".$row[4]."</h5>";
    ...
    {
      header("location:userhome.php?message='Try Another keywords'");
    }
	  ?>
