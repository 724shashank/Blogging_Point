...
<h1 style="text-align: center;background-color:#4C4A48;color:white;"><u>Verify-User</u></h1>
...
$query="select registration.username,registration.name,login.pswd,registration.status from registration,login where registration.username=login.username";
